...
export function PageThreadProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageThreadProjection {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(ThreadProjectionFromJSON)),
...
export function PageThreadProjectionToJSON(value?: PageThreadProjection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(ThreadProjectionToJSON)),
