...
export function PageInboxProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageInboxProjection {
    ...
    return {
        ...
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(InboxProjectionFromJSON)),
...
export function PageInboxProjectionToJSON(value?: PageInboxProjection | null): any {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(InboxProjectionToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
