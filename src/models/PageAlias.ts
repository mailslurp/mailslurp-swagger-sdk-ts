...
export function PageAliasFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageAlias {
    ...
    return {
        ...
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(AliasFromJSON)),
...
export function PageAliasToJSON(value?: PageAlias | null): any {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(AliasToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
