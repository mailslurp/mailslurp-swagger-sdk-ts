...
export function TestNewInboxRulesetOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestNewInboxRulesetOptions {
    ...
    return {
        ...
        'inboxRulesetTestOptions': !exists(json, 'inboxRulesetTestOptions') ? undefined : InboxRulesetTestOptionsFromJSON(json['inboxRulesetTestOptions']),
        'createInboxRulesetOptions': !exists(json, 'createInboxRulesetOptions') ? undefined : CreateInboxRulesetOptionsFromJSON(json['createInboxRulesetOptions']),
    };
}
