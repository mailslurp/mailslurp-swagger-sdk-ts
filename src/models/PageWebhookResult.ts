...
import {
    ...
    WebhookResultEntityFromJSONTyped,
...
export function PageWebhookResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageWebhookResult {
    ...
    return {
        ...
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(WebhookResultEntityFromJSON)),
...
export function PageWebhookResultToJSON(value?: PageWebhookResult | null): any {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(WebhookResultEntityToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
