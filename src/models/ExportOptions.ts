...
export function ExportOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExportOptions {
    ...
    return {
        ...
        'createdEarliestTime': !exists(json, 'createdEarliestTime') ? undefined : (new Date(json['createdEarliestTime'])),
        'createdOldestTime': !exists(json, 'createdOldestTime') ? undefined : (new Date(json['createdOldestTime'])),
...
export function ExportOptionsToJSON(value?: ExportOptions | null): any {
    ...
    return {
        ...
        'createdEarliestTime': value.createdEarliestTime === undefined ? undefined : (value.createdEarliestTime.toISOString()),
        'createdOldestTime': value.createdOldestTime === undefined ? undefined : (value.createdOldestTime.toISOString()),
        'filter': value.filter,
