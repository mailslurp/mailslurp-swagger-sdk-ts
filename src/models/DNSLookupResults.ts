...
export function DNSLookupResultsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DNSLookupResults {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(DNSLookupResultFromJSON)),
    };
}
...
export function DNSLookupResultsToJSON(value?: DNSLookupResults | null): any {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(DNSLookupResultToJSON)),
    };
}
