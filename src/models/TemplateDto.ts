...
export function TemplateDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateDto {
    ...
    return {
        ...
        'variables': !exists(json, 'variables') ? undefined : ((json['variables'] as Array<any>).map(TemplateVariableFromJSON)),
...
export function TemplateDtoToJSON(value?: TemplateDto | null): any {
    ...
    return {
        ...
        'id': value.id,
        'name': value.name,
        'variables': value.variables === undefined ? undefined : ((value.variables as Array<any>).map(TemplateVariableToJSON)),
