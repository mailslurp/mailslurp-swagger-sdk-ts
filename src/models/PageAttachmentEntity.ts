...
export function PageAttachmentEntityFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageAttachmentEntity {
    ...
    return {
        ...
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(AttachmentEntityFromJSON)),
...
export function PageAttachmentEntityToJSON(value?: PageAttachmentEntity | null): any {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(AttachmentEntityToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
