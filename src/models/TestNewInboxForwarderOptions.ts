...
export function TestNewInboxForwarderOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestNewInboxForwarderOptions {
    ...
    return {
        ...
        'inboxForwarderTestOptions': !exists(json, 'inboxForwarderTestOptions') ? undefined : InboxForwarderTestOptionsFromJSON(json['inboxForwarderTestOptions']),
        'createInboxForwarderOptions': !exists(json, 'createInboxForwarderOptions') ? undefined : CreateInboxForwarderOptionsFromJSON(json['createInboxForwarderOptions']),
    };
}
