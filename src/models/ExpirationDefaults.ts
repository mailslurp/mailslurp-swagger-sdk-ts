...
export function ExpirationDefaultsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExpirationDefaults {
    ...
    return {
        ...
        'canPermanentInbox': !exists(json, 'canPermanentInbox') ? undefined : json['canPermanentInbox'],
        'nextInboxAllowsPermanent': !exists(json, 'nextInboxAllowsPermanent') ? undefined : json['nextInboxAllowsPermanent'],
    };
}
