...
export function GroupContactsDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupContactsDto {
    ...
    return {
        ...
        'group': !exists(json, 'group') ? undefined : GroupDtoFromJSON(json['group']),
        'contacts': !exists(json, 'contacts') ? undefined : ((json['contacts'] as Array<any>).map(ContactDtoFromJSON)),
    };
}
...
export function GroupContactsDtoToJSON(value?: GroupContactsDto | null): any {
    ...
    return {
        ...
        'contacts': value.contacts === undefined ? undefined : ((value.contacts as Array<any>).map(ContactDtoToJSON)),
    };
}
