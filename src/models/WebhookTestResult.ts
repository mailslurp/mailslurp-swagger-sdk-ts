...
export function WebhookTestResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookTestResult {
    ...
    return {
        ...
        'response': !exists(json, 'response') ? undefined : WebhookTestResponseFromJSON(json['response']),
        'request': !exists(json, 'request') ? undefined : WebhookTestRequestFromJSON(json['request']),
    };
}
