...
export interface DomainControllerApiInterface {
     ...
     */
    addDomainWildcardCatchAllRaw(requestParameters: AddDomainWildcardCatchAllRequest): Promise<runtime.ApiResponse<DomainDto>>;

    /**
     * Add a catch all inbox to a domain so that any emails sent to it that cannot be matched will be sent to the catch all inbox generated
     * Add catch all wild card inbox to domain
     */
    addDomainWildcardCatchAll(requestParameters: AddDomainWildcardCatchAllRequest): Promise<DomainDto>;
     ...
     * @memberof DomainControllerApiInterface
     */
    deleteDomainRaw(requestParameters: DeleteDomainRequest): Promise<runtime.ApiResponse<Array<string>>>;

    /**
     * Delete a domain. This will disable any existing inboxes that use this domain.
     * Delete a domain
     */
    deleteDomain(requestParameters: DeleteDomainRequest): Promise<Array<string>>;
     ...
     * @memberof DomainControllerApiInterface
     */
    updateDomainRaw(requestParameters: UpdateDomainRequest): Promise<runtime.ApiResponse<DomainDto>>;

    /**
     * Update values on a domain. Note you cannot change the domain name as it is immutable. Recreate the domain if you need to alter this.
     * Update a domain
     */
    updateDomain(requestParameters: UpdateDomainRequest): Promise<DomainDto>;
...
export class DomainControllerApi extends runtime.BaseAPI implements DomainControllerApiInterface {
     ...
     * Add catch all wild card inbox to domain
     */
    async addDomainWildcardCatchAllRaw(requestParameters: AddDomainWildcardCatchAllRequest): Promise<runtime.ApiResponse<DomainDto>> {
     ...
     * Add catch all wild card inbox to domain
     */
    async addDomainWildcardCatchAll(requestParameters: AddDomainWildcardCatchAllRequest): Promise<DomainDto> {
        const response = await this.addDomainWildcardCatchAllRaw(requestParameters);
     ...
     * Delete a domain
     */
    async deleteDomainRaw(requestParameters: DeleteDomainRequest): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
     ...
     * Delete a domain
     */
    async deleteDomain(requestParameters: DeleteDomainRequest): Promise<Array<string>> {
     ...
     * Update a domain
     */
    async updateDomainRaw(requestParameters: UpdateDomainRequest): Promise<runtime.ApiResponse<DomainDto>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
        ...
        if (requestParameters.updateDomainDto === null || requestParameters.updateDomainDto === undefined) {
            throw new runtime.RequiredError('updateDomainDto','Required parameter requestParameters.updateDomainDto was null or undefined when calling updateDomain.');
        }
     ...
     * Update a domain
     */
    async updateDomain(requestParameters: UpdateDomainRequest): Promise<DomainDto> {
