...
export interface WebhookControllerApiInterface {
     ...
     * @memberof WebhookControllerApiInterface
     */
    deleteAllWebhooksRaw(): Promise<runtime.ApiResponse<void>>;
     ...
     * @memberof WebhookControllerApiInterface
     */
    getJsonSchemaForWebhookPayloadRaw(requestParameters: GetJsonSchemaForWebhookPayloadRequest): Promise<runtime.ApiResponse<JSONSchemaDto>>;

    /**
     * Get JSON Schema definition for webhook payload
     */
    getJsonSchemaForWebhookPayload(requestParameters: GetJsonSchemaForWebhookPayloadRequest): Promise<JSONSchemaDto>;

    /**
     * Get test webhook payload example. Response content depends on eventName passed. Uses `EMAIL_RECEIVED` as default.
     * @param {'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ'} [eventName] 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof WebhookControllerApiInterface
     */
     ...
     * @memberof WebhookControllerApiInterface
     */
    getTestWebhookPayloadEmailReadRaw(): Promise<runtime.ApiResponse<WebhookEmailReadPayload>>;

    /**
     * Get webhook test payload for email opened event
     */
    getTestWebhookPayloadEmailRead(): Promise<WebhookEmailReadPayload>;
     ...
     * @memberof WebhookControllerApiInterface
     */
    getTestWebhookPayloadForWebhookRaw(requestParameters: GetTestWebhookPayloadForWebhookRequest): Promise<runtime.ApiResponse<AbstractWebhookPayload>>;

    /**
     * Get example payload for webhook
     */
    getTestWebhookPayloadForWebhook(requestParameters: GetTestWebhookPayloadForWebhookRequest): Promise<AbstractWebhookPayload>;
     ...
     * @memberof WebhookControllerApiInterface
     */
    getWebhookResultRaw(requestParameters: GetWebhookResultRequest): Promise<runtime.ApiResponse<WebhookResultDto>>;

    /**
     * Get a webhook result for a webhook
     */
    getWebhookResult(requestParameters: GetWebhookResultRequest): Promise<WebhookResultDto>;
     ...
     * @memberof WebhookControllerApiInterface
     */
    getWebhookResultsUnseenErrorCountRaw(requestParameters: GetWebhookResultsUnseenErrorCountRequest): Promise<runtime.ApiResponse<UnseenErrorCountDto>>;

    /**
     * Get count of unseen webhook results with error status
     */
    getWebhookResultsUnseenErrorCount(requestParameters: GetWebhookResultsUnseenErrorCountRequest): Promise<UnseenErrorCountDto>;
     ...
     * @memberof WebhookControllerApiInterface
     */
    redriveWebhookResultRaw(requestParameters: RedriveWebhookResultRequest): Promise<runtime.ApiResponse<WebhookRedriveResult>>;

    /**
     * Allows you to resend a webhook payload that was already sent. Webhooks that fail are retried automatically for 24 hours and then put in a dead letter queue. You can retry results manually using this method.
     * Get a webhook result and try to resend the original webhook payload
     */
    redriveWebhookResult(requestParameters: RedriveWebhookResultRequest): Promise<WebhookRedriveResult>;
...
export class WebhookControllerApi extends runtime.BaseAPI implements WebhookControllerApiInterface {
     ...
     * Delete all webhooks
     */
    async deleteAllWebhooksRaw(): Promise<runtime.ApiResponse<void>> {
        const queryParameters: runtime.HTTPQuery = {};
    ...
    async deleteAllWebhooks(): Promise<void> {
        await this.deleteAllWebhooksRaw();
    }
     ...
     * Get JSON Schema definition for webhook payload
     */
    async getJsonSchemaForWebhookPayloadRaw(requestParameters: GetJsonSchemaForWebhookPayloadRequest): Promise<runtime.ApiResponse<JSONSchemaDto>> {
        if (requestParameters.webhookId === null || requestParameters.webhookId === undefined) {
     ...
     * Get JSON Schema definition for webhook payload
     */
    async getJsonSchemaForWebhookPayload(requestParameters: GetJsonSchemaForWebhookPayloadRequest): Promise<JSONSchemaDto> {
        const response = await this.getJsonSchemaForWebhookPayloadRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get webhook test payload for email opened event
     */
    async getTestWebhookPayloadEmailReadRaw(): Promise<runtime.ApiResponse<WebhookEmailReadPayload>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Get webhook test payload for email opened event
     */
    async getTestWebhookPayloadEmailRead(): Promise<WebhookEmailReadPayload> {
     ...
     * Get example payload for webhook
     */
    async getTestWebhookPayloadForWebhookRaw(requestParameters: GetTestWebhookPayloadForWebhookRequest): Promise<runtime.ApiResponse<AbstractWebhookPayload>> {
        if (requestParameters.webhookId === null || requestParameters.webhookId === undefined) {
     ...
     * Get example payload for webhook
     */
    async getTestWebhookPayloadForWebhook(requestParameters: GetTestWebhookPayloadForWebhookRequest): Promise<AbstractWebhookPayload> {
        const response = await this.getTestWebhookPayloadForWebhookRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get a webhook result for a webhook
     */
    async getWebhookResultRaw(requestParameters: GetWebhookResultRequest): Promise<runtime.ApiResponse<WebhookResultDto>> {
     ...
     * Get a webhook result for a webhook
     */
    async getWebhookResult(requestParameters: GetWebhookResultRequest): Promise<WebhookResultDto> {
     ...
     * Get count of unseen webhook results with error status
     */
    async getWebhookResultsUnseenErrorCountRaw(requestParameters: GetWebhookResultsUnseenErrorCountRequest): Promise<runtime.ApiResponse<UnseenErrorCountDto>> {
        if (requestParameters.inboxId === null || requestParameters.inboxId === undefined) {
     ...
     * Get count of unseen webhook results with error status
     */
    async getWebhookResultsUnseenErrorCount(requestParameters: GetWebhookResultsUnseenErrorCountRequest): Promise<UnseenErrorCountDto> {
        const response = await this.getWebhookResultsUnseenErrorCountRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get a webhook result and try to resend the original webhook payload
     */
    async redriveWebhookResultRaw(requestParameters: RedriveWebhookResultRequest): Promise<runtime.ApiResponse<WebhookRedriveResult>> {
        if (requestParameters.webhookResultId === null || requestParameters.webhookResultId === undefined) {
     ...
     * Get a webhook result and try to resend the original webhook payload
     */
    async redriveWebhookResult(requestParameters: RedriveWebhookResultRequest): Promise<WebhookRedriveResult> {
        const response = await this.redriveWebhookResultRaw(requestParameters);
        return await response.value();
    }
