...
export interface WebhookControllerApiInterface {
     ...
     * @memberof WebhookControllerApiInterface
     */
    getTestWebhookPayloadRaw(): Promise<runtime.ApiResponse<WebhookPayload>>;

    /**
     * Get test webhook payload example
     */
    getTestWebhookPayload(): Promise<WebhookPayload>;
...
export class WebhookControllerApi extends runtime.BaseAPI implements WebhookControllerApiInterface {
     ...
     * Get test webhook payload example
     */
    async getTestWebhookPayloadRaw(): Promise<runtime.ApiResponse<WebhookPayload>> {
        const queryParameters: runtime.HTTPQuery = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => WebhookPayloadFromJSON(jsonValue));
    }

    /**
     * Get test webhook payload example
     */
    async getTestWebhookPayload(): Promise<WebhookPayload> {
