...
export interface AliasControllerApiInterface {
     ...
     * @memberof AliasControllerApiInterface
     */
    updateAliasRaw(requestParameters: UpdateAliasRequest): Promise<runtime.ApiResponse<AliasDto>>;

    /**
     * Update an email alias
     */
    updateAlias(requestParameters: UpdateAliasRequest): Promise<AliasDto>;
...
export class AliasControllerApi extends runtime.BaseAPI implements AliasControllerApiInterface {
     ...
     * Update an email alias
     */
    async updateAliasRaw(requestParameters: UpdateAliasRequest): Promise<runtime.ApiResponse<AliasDto>> {
        if (requestParameters.aliasId === null || requestParameters.aliasId === undefined) {
     ...
     * Update an email alias
     */
    async updateAlias(requestParameters: UpdateAliasRequest): Promise<AliasDto> {
