...
export class AliasControllerApi extends runtime.BaseAPI implements AliasControllerApiInterface {
    ...
    async replyToEmailRaw(requestParameters: ReplyToEmailRequest): Promise<runtime.ApiResponse<SentEmailDto>> {
        if (requestParameters.aliasId === null || requestParameters.aliasId === undefined) {
            throw new runtime.RequiredError('aliasId','Required parameter requestParameters.aliasId was null or undefined when calling replyToEmail.');
        }
        ...
        if (requestParameters.replyToAliasEmailOptions === null || requestParameters.replyToAliasEmailOptions === undefined) {
            throw new runtime.RequiredError('replyToAliasEmailOptions','Required parameter requestParameters.replyToAliasEmailOptions was null or undefined when calling replyToEmail.');
        }
