...
import {
    ...
    AliasVerificationResultFromJSON,
    AliasVerificationResultToJSON,
    CreateAliasOptions,
...
export interface GetAliasVerificationRequest {
    aliasId: string;
    emailAddress: string;
...
export interface AliasControllerApiInterface {
     ...
     */
    createAliasRaw(requestParameters: CreateAliasRequest): Promise<runtime.ApiResponse<Alias>>;

    /**
     * Email aliases use a MailSlurp randomly generated email address (or a custom domain inbox that you provide) to mask or proxy a real email address. Emails sent to the alias address will be forwarded to the hidden email address it was created for. If you want to send a reply use the threadId attached
     * Create an email alias. Must be verified by clicking link inside verification email that will be sent to the address. Once verified the alias will be active.
     */
    createAlias(requestParameters: CreateAliasRequest): Promise<Alias>;
     ...
     * @memberof AliasControllerApiInterface
     */
    getAliasVerificationRaw(requestParameters: GetAliasVerificationRequest): Promise<runtime.ApiResponse<AliasVerificationResult>>;

    /**
     * Verify an email alias email address with the verification token that was emailed to the address
     * Get validation result from alias verification
     */
    getAliasVerification(requestParameters: GetAliasVerificationRequest): Promise<AliasVerificationResult>;
...
export class AliasControllerApi extends runtime.BaseAPI implements AliasControllerApiInterface {
     ...
     * Get validation result from alias verification
     */
    async getAliasVerificationRaw(requestParameters: GetAliasVerificationRequest): Promise<runtime.ApiResponse<AliasVerificationResult>> {
        if (requestParameters.aliasId === null || requestParameters.aliasId === undefined) {
            throw new runtime.RequiredError('aliasId','Required parameter requestParameters.aliasId was null or undefined when calling getAliasVerification.');
        }

        if (requestParameters.emailAddress === null || requestParameters.emailAddress === undefined) {
            throw new runtime.RequiredError('emailAddress','Required parameter requestParameters.emailAddress was null or undefined when calling getAliasVerification.');
        }

        if (requestParameters.verificationToken === null || requestParameters.verificationToken === undefined) {
            throw new runtime.RequiredError('verificationToken','Required parameter requestParameters.verificationToken was null or undefined when calling getAliasVerification.');
        }
        ...
        const response = await this.request({
            path: `/aliases/{aliasId}/verification`.replace(`{${"aliasId"}}`, encodeURIComponent(String(requestParameters.aliasId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => AliasVerificationResultFromJSON(jsonValue));
    }
     ...
     * Get validation result from alias verification
     */
    async getAliasVerification(requestParameters: GetAliasVerificationRequest): Promise<AliasVerificationResult> {
        const response = await this.getAliasVerificationRaw(requestParameters);
        return await response.value();
    }
