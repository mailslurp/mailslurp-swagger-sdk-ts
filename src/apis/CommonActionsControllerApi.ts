...
export class CommonActionsControllerApi extends runtime.BaseAPI implements CommonActionsControllerApiInterface {
    ...
    async createNewEmailAddressRaw(requestParameters: CreateNewEmailAddressRequest): Promise<runtime.ApiResponse<Inbox>> {
        if (requestParameters.useDomainPool === null || requestParameters.useDomainPool === undefined) {
            throw new runtime.RequiredError('useDomainPool','Required parameter requestParameters.useDomainPool was null or undefined when calling createNewEmailAddress.');
        }
    ...
    async createNewEmailAddress1Raw(requestParameters: CreateNewEmailAddress1Request): Promise<runtime.ApiResponse<Inbox>> {
        if (requestParameters.useDomainPool === null || requestParameters.useDomainPool === undefined) {
            throw new runtime.RequiredError('useDomainPool','Required parameter requestParameters.useDomainPool was null or undefined when calling createNewEmailAddress1.');
        }
