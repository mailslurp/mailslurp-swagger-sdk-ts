...
export interface CommonActionsControllerApiInterface {
     ...
     */
    createNewEmailAddressRaw(): Promise<runtime.ApiResponse<Inbox>>;
     ...
     * @memberof CommonActionsControllerApiInterface
     */
    createNewEmailAddress1Raw(): Promise<runtime.ApiResponse<Inbox>>;

    /**
     * Returns an Inbox with an `id` and an `emailAddress`
     * Create new random inbox
     */
    createNewEmailAddress1(): Promise<Inbox>;
...
export class CommonActionsControllerApi extends runtime.BaseAPI implements CommonActionsControllerApiInterface {
     ...
     * Create new random inbox
     */
    async createNewEmailAddress1Raw(): Promise<runtime.ApiResponse<Inbox>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Create new random inbox
     */
    async createNewEmailAddress1(): Promise<Inbox> {
