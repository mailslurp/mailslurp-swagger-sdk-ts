...
export interface CommonActionsControllerApiInterface {
     ...
     * @memberof CommonActionsControllerApiInterface
     */
    createRandomInboxRaw(requestParameters: CreateRandomInboxRequest): Promise<runtime.ApiResponse<InboxDto>>;

    /**
     * Returns an Inbox with an `id` and an `emailAddress`
     * Create new random inbox
     */
    createRandomInbox(requestParameters: CreateRandomInboxRequest): Promise<InboxDto>;
...
export class CommonActionsControllerApi extends runtime.BaseAPI implements CommonActionsControllerApiInterface {
     ...
     * Create new random inbox
     */
    async createRandomInboxRaw(requestParameters: CreateRandomInboxRequest): Promise<runtime.ApiResponse<InboxDto>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Create new random inbox
     */
    async createRandomInbox(requestParameters: CreateRandomInboxRequest): Promise<InboxDto> {
        const response = await this.createRandomInboxRaw(requestParameters);
        return await response.value();
    }
