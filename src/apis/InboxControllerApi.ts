...
export interface InboxControllerApiInterface {
     ...
     * @memberof InboxControllerApiInterface
     */
    getInboxesRaw(): Promise<runtime.ApiResponse<Array<Inbox>>>;

    /**
     * List the inboxes you have created
     * List Inboxes / Email Addresses
     */
    getInboxes(): Promise<Array<Inbox>>;
     ...
     * @memberof InboxControllerApiInterface
     */
    sendEmailAndConfirmRaw(requestParameters: SendEmailAndConfirmRequest): Promise<runtime.ApiResponse<SentEmail>>;

    /**
     * Sister method for standard `sendEmail` method with the benefit of returning a `SentEmail` entity confirming the successful sending of the email with link the the sent object created for it.
     * Send email and return sent confirmation
     */
    sendEmailAndConfirm(requestParameters: SendEmailAndConfirmRequest): Promise<SentEmail>;
...
export class InboxControllerApi extends runtime.BaseAPI implements InboxControllerApiInterface {
     ...
     * Send email and return sent confirmation
     */
    async sendEmailAndConfirmRaw(requestParameters: SendEmailAndConfirmRequest): Promise<runtime.ApiResponse<SentEmail>> {
        if (requestParameters.inboxId === null || requestParameters.inboxId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SentEmailFromJSON(jsonValue));
    }
     ...
     * Send email and return sent confirmation
     */
    async sendEmailAndConfirm(requestParameters: SendEmailAndConfirmRequest): Promise<SentEmail> {
