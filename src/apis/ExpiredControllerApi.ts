...
export interface ExpiredControllerApiInterface {
     ...
     * @param {string} iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ExpiredControllerApiInterface
     */
...
export class ExpiredControllerApi extends runtime.BaseAPI implements ExpiredControllerApiInterface {
    ...
    async getExpiredInboxRecordRaw(requestParameters: GetExpiredInboxRecordRequest): Promise<runtime.ApiResponse<ExpiredInboxDto>> {
        if (requestParameters.iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId === null || requestParameters.iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId === undefined) {
            throw new runtime.RequiredError('iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId','Required parameter requestParameters.iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId was null or undefined when calling getExpiredInboxRecord.');
        }
