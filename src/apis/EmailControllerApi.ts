...
export interface EmailControllerApiInterface {
     ...
     * @memberof EmailControllerApiInterface
     */
    downloadAttachmentRaw(requestParameters: DownloadAttachmentRequest): Promise<runtime.ApiResponse<Array<string>>>;

    /**
     * Returns the specified attachment for a given email as a stream / array of bytes. You can find attachment ids in email responses endpoint responses. The response type is application/octet-stream.
     * Get email attachment bytes. Returned as `octet-stream` with content type header. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints and convert the base 64 encoded content to a file or string.
     */
    downloadAttachment(requestParameters: DownloadAttachmentRequest): Promise<Array<string>>;
     ...
     * @memberof EmailControllerApiInterface
     */
    downloadBodyBytesRaw(requestParameters: DownloadBodyBytesRequest): Promise<runtime.ApiResponse<Array<string>>>;

    /**
     * Returns the specified email body for a given email as a stream / array of bytes.
     * Get email body in bytes. Returned as `octet-stream` with content type header.
     */
    downloadBodyBytes(requestParameters: DownloadBodyBytesRequest): Promise<Array<string>>;
...
export class EmailControllerApi extends runtime.BaseAPI implements EmailControllerApiInterface {
     ...
     * Get email attachment bytes. Returned as `octet-stream` with content type header. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints and convert the base 64 encoded content to a file or string.
     */
    async downloadAttachmentRaw(requestParameters: DownloadAttachmentRequest): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Get email attachment bytes. Returned as `octet-stream` with content type header. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints and convert the base 64 encoded content to a file or string.
     */
    async downloadAttachment(requestParameters: DownloadAttachmentRequest): Promise<Array<string>> {
     ...
     * Get email body in bytes. Returned as `octet-stream` with content type header.
     */
    async downloadBodyBytesRaw(requestParameters: DownloadBodyBytesRequest): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Get email body in bytes. Returned as `octet-stream` with content type header.
     */
    async downloadBodyBytes(requestParameters: DownloadBodyBytesRequest): Promise<Array<string>> {
