...
export class EmailControllerApi extends runtime.BaseAPI implements EmailControllerApiInterface {
    ...
    async getEmailHTMLQueryRaw(requestParameters: GetEmailHTMLQueryRequest): Promise<runtime.ApiResponse<EmailTextLinesResult>> {
        ...
        const response = await this.request({
            path: `/emails/{emailId}/html-query`.replace(`{${"emailId"}}`, encodeURIComponent(String(requestParameters.emailId))).replace(`{${"htmlSelector"}}`, encodeURIComponent(String(requestParameters.htmlSelector))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async getEmailTextLinesRaw(requestParameters: GetEmailTextLinesRequest): Promise<runtime.ApiResponse<EmailTextLinesResult>> {
        if (requestParameters.decodeHtmlEntities === null || requestParameters.decodeHtmlEntities === undefined) {
            throw new runtime.RequiredError('decodeHtmlEntities','Required parameter requestParameters.decodeHtmlEntities was null or undefined when calling getEmailTextLines.');
        }
        ...
        const response = await this.request({
            path: `/emails/{emailId}/text`.replace(`{${"decodeHtmlEntities"}}`, encodeURIComponent(String(requestParameters.decodeHtmlEntities))).replace(`{${"emailId"}}`, encodeURIComponent(String(requestParameters.emailId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        });
