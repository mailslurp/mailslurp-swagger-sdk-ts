...
export interface EmailControllerApiInterface {
     ...
     * @memberof EmailControllerApiInterface
     */
    getAttachments1Raw(requestParameters: GetAttachments1Request): Promise<runtime.ApiResponse<Array<AttachmentMetaData>>>;

    /**
     * Returns an array of attachment metadata such as name and content-type for a given email if present.
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    getAttachments1(requestParameters: GetAttachments1Request): Promise<Array<AttachmentMetaData>>;
...
export class EmailControllerApi extends runtime.BaseAPI implements EmailControllerApiInterface {
     ...
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    async getAttachments1Raw(requestParameters: GetAttachments1Request): Promise<runtime.ApiResponse<Array<AttachmentMetaData>>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    async getAttachments1(requestParameters: GetAttachments1Request): Promise<Array<AttachmentMetaData>> {
        const response = await this.getAttachments1Raw(requestParameters);
        return await response.value();
    }
