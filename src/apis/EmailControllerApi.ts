...
export interface ReplyToEmail1Request {
    emailId: string;
...
export interface EmailControllerApiInterface {
     ...
     * @memberof EmailControllerApiInterface
     */
    replyToEmail1Raw(requestParameters: ReplyToEmail1Request): Promise<runtime.ApiResponse<SentEmailDto>>;

    /**
     * Send the reply to the email sender or reply-to and include same subject cc bcc etc. Reply to an email and the contents will be sent with the existing subject to the emails `to`, `cc`, and `bcc`.
     * Reply to an email
     */
    replyToEmail1(requestParameters: ReplyToEmail1Request): Promise<SentEmailDto>;
...
export class EmailControllerApi extends runtime.BaseAPI implements EmailControllerApiInterface {
     ...
     * Reply to an email
     */
    async replyToEmail1Raw(requestParameters: ReplyToEmail1Request): Promise<runtime.ApiResponse<SentEmailDto>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
            throw new runtime.RequiredError('emailId','Required parameter requestParameters.emailId was null or undefined when calling replyToEmail1.');
        }

        if (requestParameters.replyToEmailOptions === null || requestParameters.replyToEmailOptions === undefined) {
            throw new runtime.RequiredError('replyToEmailOptions','Required parameter requestParameters.replyToEmailOptions was null or undefined when calling replyToEmail1.');
        }
     ...
     * Reply to an email
     */
    async replyToEmail1(requestParameters: ReplyToEmail1Request): Promise<SentEmailDto> {
        const response = await this.replyToEmail1Raw(requestParameters);
        return await response.value();
    }
