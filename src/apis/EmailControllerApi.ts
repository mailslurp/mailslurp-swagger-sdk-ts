...
export interface EmailControllerApiInterface {
     ...
     * @memberof EmailControllerApiInterface
     */
    downloadBodyRaw(requestParameters: DownloadBodyRequest): Promise<runtime.ApiResponse<string>>;

    /**
     * Returns the specified email body for a given email as a string
     * Get email body as string. Returned as `plain/text` with content type header.
     */
    downloadBody(requestParameters: DownloadBodyRequest): Promise<string>;
     ...
     * @memberof EmailControllerApiInterface
     */
    downloadBodyBytesRaw(requestParameters: DownloadBodyBytesRequest): Promise<runtime.ApiResponse<string>>;

    /**
     * Returns the specified email body for a given email as a stream / array of bytes.
     * Get email body in bytes. Returned as `octet-stream` with content type header.
     */
    downloadBodyBytes(requestParameters: DownloadBodyBytesRequest): Promise<string>;
     ...
     * @memberof EmailControllerApiInterface
     */
    forwardEmailRaw(requestParameters: ForwardEmailRequest): Promise<runtime.ApiResponse<SentEmailDto>>;

    /**
     * Forward an existing email to new recipients. The sender of the email will be the inbox that received the email you are forwarding. You can override the sender with the `from` option. Note you must have access to the from address in MailSlurp to use the override. For more control consider fetching the email and sending it a new using the send email endpoints.
     * Forward email to recipients
     */
    forwardEmail(requestParameters: ForwardEmailRequest): Promise<SentEmailDto>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getEmailAttachmentsRaw(requestParameters: GetEmailAttachmentsRequest): Promise<runtime.ApiResponse<Array<AttachmentMetaData>>>;

    /**
     * Returns an array of attachment metadata such as name and content-type for a given email if present.
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    getEmailAttachments(requestParameters: GetEmailAttachmentsRequest): Promise<Array<AttachmentMetaData>>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getEmailContentMatchRaw(requestParameters: GetEmailContentMatchRequest): Promise<runtime.ApiResponse<EmailContentMatchResult>>;

    /**
     * Return the matches for a given Java style regex pattern. Do not include the typical `/` at start or end of regex in some languages. Given an example `your code is: 12345` the pattern to extract match looks like `code is: (\\d{6})`. This will return an array of matches with the first matching the entire pattern and the subsequent matching the groups: `[\'code is: 123456\', \'123456\']` See https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html for more information of available patterns. 
     * Get email content regex pattern match results. Runs regex against email body and returns match groups.
     */
    getEmailContentMatch(requestParameters: GetEmailContentMatchRequest): Promise<EmailContentMatchResult>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getEmailCountRaw(): Promise<runtime.ApiResponse<CountDto>>;

    /**
     * Get email count
     */
    getEmailCount(): Promise<CountDto>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getEmailHTMLQueryRaw(requestParameters: GetEmailHTMLQueryRequest): Promise<runtime.ApiResponse<EmailTextLinesResult>>;

    /**
     * Parse an email body and return the content as an array of text. HTML parsing uses JSoup which supports JQuery/CSS style selectors
     * Parse and return text from an email, stripping HTML and decoding encoded characters
     */
    getEmailHTMLQuery(requestParameters: GetEmailHTMLQueryRequest): Promise<EmailTextLinesResult>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getEmailLinksRaw(requestParameters: GetEmailLinksRequest): Promise<runtime.ApiResponse<EmailLinksResult>>;

    /**
     * HTML parsing uses JSoup and UNIX line separators. Searches content for href attributes
     * Parse and return list of links found in an email (only works for HTML content)
     */
    getEmailLinks(requestParameters: GetEmailLinksRequest): Promise<EmailLinksResult>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getEmailTextLinesRaw(requestParameters: GetEmailTextLinesRequest): Promise<runtime.ApiResponse<EmailTextLinesResult>>;

    /**
     * Parse an email body and return the content as an array of strings. HTML parsing uses JSoup and UNIX line separators.
     * Parse and return text from an email, stripping HTML and decoding encoded characters
     */
    getEmailTextLines(requestParameters: GetEmailTextLinesRequest): Promise<EmailTextLinesResult>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getGravatarUrlForEmailAddressRaw(requestParameters: GetGravatarUrlForEmailAddressRequest): Promise<runtime.ApiResponse<GravatarUrl>>;

    /**
     * Get gravatar url for email address
     */
    getGravatarUrlForEmailAddress(requestParameters: GetGravatarUrlForEmailAddressRequest): Promise<GravatarUrl>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getLatestEmailRaw(requestParameters: GetLatestEmailRequest): Promise<runtime.ApiResponse<Email>>;

    /**
     * Get the newest email in all inboxes or in a passed set of inbox IDs
     * Get latest email in all inboxes. Most recently received.
     */
    getLatestEmail(requestParameters: GetLatestEmailRequest): Promise<Email>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getLatestEmailInInboxRaw(requestParameters: GetLatestEmailInInboxRequest): Promise<runtime.ApiResponse<Email>>;

    /**
     * Get the newest email in all inboxes or in a passed set of inbox IDs
     * Get latest email in an inbox. Use `WaitForController` to get emails that may not have arrived yet.
     */
    getLatestEmailInInbox(requestParameters: GetLatestEmailInInboxRequest): Promise<Email>;
     ...
     * @memberof EmailControllerApiInterface
     */
    getOrganizationEmailsPaginatedRaw(requestParameters: GetOrganizationEmailsPaginatedRequest): Promise<runtime.ApiResponse<PageEmailProjection>>;

    /**
     * By default returns all emails across all team inboxes sorted by ascending created at date. Responses are paginated. You can restrict results to a list of inbox IDs. You can also filter out read messages
     * Get all organization emails. List team or shared test email accounts
     */
    getOrganizationEmailsPaginated(requestParameters: GetOrganizationEmailsPaginatedRequest): Promise<PageEmailProjection>;
     ...
     * @memberof EmailControllerApiInterface
     */
    markAsReadRaw(requestParameters: MarkAsReadRequest): Promise<runtime.ApiResponse<EmailPreview>>;

    /**
     * Marks an email as read or unread. Pass boolean read flag to set value. This is useful if you want to read an email but keep it as unread
     * Mark an email as read on unread
     */
    markAsRead(requestParameters: MarkAsReadRequest): Promise<EmailPreview>;
     ...
     * @memberof EmailControllerApiInterface
     */
    replyToEmailRaw(requestParameters: ReplyToEmailRequest): Promise<runtime.ApiResponse<SentEmailDto>>;

    /**
     * Send the reply to the email sender or reply-to and include same subject cc bcc etc. Reply to an email and the contents will be sent with the existing subject to the emails `to`, `cc`, and `bcc`.
     * Reply to an email
     */
    replyToEmail(requestParameters: ReplyToEmailRequest): Promise<SentEmailDto>;
     ...
     * @memberof EmailControllerApiInterface
     */
    sendEmailSourceOptionalRaw(requestParameters: SendEmailSourceOptionalRequest): Promise<runtime.ApiResponse<void>>;

    /**
     * Alias for `InboxController.sendEmail` method - see original method for full details. Sends an email from a given inbox that you have created. If no inbox is supplied a random inbox will be created for you and used to send the email.
     * Send email
     */
    sendEmailSourceOptional(requestParameters: SendEmailSourceOptionalRequest): Promise<void>;
...
export class EmailControllerApi extends runtime.BaseAPI implements EmailControllerApiInterface {
     ...
     * Get email body as string. Returned as `plain/text` with content type header.
     */
    async downloadBodyRaw(requestParameters: DownloadBodyRequest): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Get email body as string. Returned as `plain/text` with content type header.
     */
    async downloadBody(requestParameters: DownloadBodyRequest): Promise<string> {
        const response = await this.downloadBodyRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get email body in bytes. Returned as `octet-stream` with content type header.
     */
    async downloadBodyBytesRaw(requestParameters: DownloadBodyBytesRequest): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Get email body in bytes. Returned as `octet-stream` with content type header.
     */
    async downloadBodyBytes(requestParameters: DownloadBodyBytesRequest): Promise<string> {
        const response = await this.downloadBodyBytesRaw(requestParameters);
        return await response.value();
    }
     ...
     * Forward email to recipients
     */
    async forwardEmailRaw(requestParameters: ForwardEmailRequest): Promise<runtime.ApiResponse<SentEmailDto>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Forward email to recipients
     */
    async forwardEmail(requestParameters: ForwardEmailRequest): Promise<SentEmailDto> {
        const response = await this.forwardEmailRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    async getEmailAttachmentsRaw(requestParameters: GetEmailAttachmentsRequest): Promise<runtime.ApiResponse<Array<AttachmentMetaData>>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    async getEmailAttachments(requestParameters: GetEmailAttachmentsRequest): Promise<Array<AttachmentMetaData>> {
        const response = await this.getEmailAttachmentsRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get email content regex pattern match results. Runs regex against email body and returns match groups.
     */
    async getEmailContentMatchRaw(requestParameters: GetEmailContentMatchRequest): Promise<runtime.ApiResponse<EmailContentMatchResult>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Get email content regex pattern match results. Runs regex against email body and returns match groups.
     */
    async getEmailContentMatch(requestParameters: GetEmailContentMatchRequest): Promise<EmailContentMatchResult> {
        const response = await this.getEmailContentMatchRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get email count
     */
    async getEmailCountRaw(): Promise<runtime.ApiResponse<CountDto>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Get email count
     */
    async getEmailCount(): Promise<CountDto> {
     ...
     * Parse and return text from an email, stripping HTML and decoding encoded characters
     */
    async getEmailHTMLQueryRaw(requestParameters: GetEmailHTMLQueryRequest): Promise<runtime.ApiResponse<EmailTextLinesResult>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Parse and return text from an email, stripping HTML and decoding encoded characters
     */
    async getEmailHTMLQuery(requestParameters: GetEmailHTMLQueryRequest): Promise<EmailTextLinesResult> {
        const response = await this.getEmailHTMLQueryRaw(requestParameters);
        return await response.value();
    }
     ...
     * Parse and return list of links found in an email (only works for HTML content)
     */
    async getEmailLinksRaw(requestParameters: GetEmailLinksRequest): Promise<runtime.ApiResponse<EmailLinksResult>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Parse and return list of links found in an email (only works for HTML content)
     */
    async getEmailLinks(requestParameters: GetEmailLinksRequest): Promise<EmailLinksResult> {
        const response = await this.getEmailLinksRaw(requestParameters);
        return await response.value();
    }
     ...
     * Parse and return text from an email, stripping HTML and decoding encoded characters
     */
    async getEmailTextLinesRaw(requestParameters: GetEmailTextLinesRequest): Promise<runtime.ApiResponse<EmailTextLinesResult>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Parse and return text from an email, stripping HTML and decoding encoded characters
     */
    async getEmailTextLines(requestParameters: GetEmailTextLinesRequest): Promise<EmailTextLinesResult> {
        const response = await this.getEmailTextLinesRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get gravatar url for email address
     */
    async getGravatarUrlForEmailAddressRaw(requestParameters: GetGravatarUrlForEmailAddressRequest): Promise<runtime.ApiResponse<GravatarUrl>> {
     ...
     * Get gravatar url for email address
     */
    async getGravatarUrlForEmailAddress(requestParameters: GetGravatarUrlForEmailAddressRequest): Promise<GravatarUrl> {
        const response = await this.getGravatarUrlForEmailAddressRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get latest email in all inboxes. Most recently received.
     */
    async getLatestEmailRaw(requestParameters: GetLatestEmailRequest): Promise<runtime.ApiResponse<Email>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Get latest email in all inboxes. Most recently received.
     */
    async getLatestEmail(requestParameters: GetLatestEmailRequest): Promise<Email> {
        const response = await this.getLatestEmailRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get latest email in an inbox. Use `WaitForController` to get emails that may not have arrived yet.
     */
    async getLatestEmailInInboxRaw(requestParameters: GetLatestEmailInInboxRequest): Promise<runtime.ApiResponse<Email>> {
     ...
     * Get latest email in an inbox. Use `WaitForController` to get emails that may not have arrived yet.
     */
    async getLatestEmailInInbox(requestParameters: GetLatestEmailInInboxRequest): Promise<Email> {
        const response = await this.getLatestEmailInInboxRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get all organization emails. List team or shared test email accounts
     */
    async getOrganizationEmailsPaginatedRaw(requestParameters: GetOrganizationEmailsPaginatedRequest): Promise<runtime.ApiResponse<PageEmailProjection>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Get all organization emails. List team or shared test email accounts
     */
    async getOrganizationEmailsPaginated(requestParameters: GetOrganizationEmailsPaginatedRequest): Promise<PageEmailProjection> {
        const response = await this.getOrganizationEmailsPaginatedRaw(requestParameters);
        return await response.value();
    }
     ...
     * Mark an email as read on unread
     */
    async markAsReadRaw(requestParameters: MarkAsReadRequest): Promise<runtime.ApiResponse<EmailPreview>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Mark an email as read on unread
     */
    async markAsRead(requestParameters: MarkAsReadRequest): Promise<EmailPreview> {
     ...
     * Reply to an email
     */
    async replyToEmailRaw(requestParameters: ReplyToEmailRequest): Promise<runtime.ApiResponse<SentEmailDto>> {
        if (requestParameters.emailId === null || requestParameters.emailId === undefined) {
     ...
     * Reply to an email
     */
    async replyToEmail(requestParameters: ReplyToEmailRequest): Promise<SentEmailDto> {
        const response = await this.replyToEmailRaw(requestParameters);
        return await response.value();
    }
     ...
     * Send email
     */
    async sendEmailSourceOptionalRaw(requestParameters: SendEmailSourceOptionalRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.inboxId === null || requestParameters.inboxId === undefined) {
     ...
     * Send email
     */
    async sendEmailSourceOptional(requestParameters: SendEmailSourceOptionalRequest): Promise<void> {
        await this.sendEmailSourceOptionalRaw(requestParameters);
    }
