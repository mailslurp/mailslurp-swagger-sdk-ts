...
export interface AttachmentControllerApiInterface {
     ...
     * @memberof AttachmentControllerApiInterface
     */
    downloadAttachmentAsBytesRaw(requestParameters: DownloadAttachmentAsBytesRequest): Promise<runtime.ApiResponse<Array<string>>>;

    /**
     * Returns the specified attachment for a given email as a stream / array of bytes. You can find attachment ids in email responses endpoint responses. The response type is application/octet-stream.
     * Download attachments. Get email attachment bytes. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints.
     */
    downloadAttachmentAsBytes(requestParameters: DownloadAttachmentAsBytesRequest): Promise<Array<string>>;
     ...
     * @memberof AttachmentControllerApiInterface
     */
    getAttachments1Raw(requestParameters: GetAttachments1Request): Promise<runtime.ApiResponse<PageAttachmentEntity>>;

    /**
     * Get all attachments in paginated response. Each entity contains meta data for the attachment such as `name` and `content-type`. Use the `attachmentId` and the download endpoints to get the file contents.
     * Get email attachments
     */
    getAttachments1(requestParameters: GetAttachments1Request): Promise<PageAttachmentEntity>;
...
export class AttachmentControllerApi extends runtime.BaseAPI implements AttachmentControllerApiInterface {
     ...
     * Download attachments. Get email attachment bytes. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints.
     */
    async downloadAttachmentAsBytesRaw(requestParameters: DownloadAttachmentAsBytesRequest): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.attachmentId === null || requestParameters.attachmentId === undefined) {
     ...
     * Download attachments. Get email attachment bytes. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints.
     */
    async downloadAttachmentAsBytes(requestParameters: DownloadAttachmentAsBytesRequest): Promise<Array<string>> {
     ...
     * Get email attachments
     */
    async getAttachments1Raw(requestParameters: GetAttachments1Request): Promise<runtime.ApiResponse<PageAttachmentEntity>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Get email attachments
     */
    async getAttachments1(requestParameters: GetAttachments1Request): Promise<PageAttachmentEntity> {
