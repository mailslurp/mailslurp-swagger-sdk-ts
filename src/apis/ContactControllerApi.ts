...
export interface ContactControllerApiInterface {
     ...
     * @memberof ContactControllerApiInterface
     */
    getContactVCardRaw(requestParameters: GetContactVCardRequest): Promise<runtime.ApiResponse<string>>;

    /**
     * Get contact vCard vcf file
     */
    getContactVCard(requestParameters: GetContactVCardRequest): Promise<string>;
...
export class ContactControllerApi extends runtime.BaseAPI implements ContactControllerApiInterface {
     ...
     * Get contact vCard vcf file
     */
    async getContactVCardRaw(requestParameters: GetContactVCardRequest): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.contactId === null || requestParameters.contactId === undefined) {
     ...
     * Get contact vCard vcf file
     */
    async getContactVCard(requestParameters: GetContactVCardRequest): Promise<string> {
